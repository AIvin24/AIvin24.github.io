...
COOLBLUE is a nice, clean, simple, yet attractive site template. The styles and layout is designed 
for blog sites which means that it can be easily ported to your preferred blogging engine.
...
Coolblue is released under the Creative Commons Attribution 3.0 License
...
Since Coolblue is distributed for free, support is not offered. Coolblue is coded according 
...
Fonts:
 - Museo Font (for the logo) (http://www.fontsquirrel.com/fonts/Museo)

icons:
 - WeFunction Free Social Icons (http://wefunction.com/2009/05/free-social-icons-app-icons/)
